///
/// MapWithContentTemplateConfig.hpp
...
namespace margelo::nitro::at::g4rb4g3::autoplay::hybrid {
  ...
  /**
   * A struct which can be represented as a JavaScript object (MapWithContentTemplateConfig).
   */
  struct MapWithContentTemplateConfig {
  public:
  ...
  public:
    MapWithContentTemplateConfig() = default;
    explicit MapWithContentTemplateConfig(std::optional<std::vector<NitroMapButton>> mapButtons, std::optional<std::vector<NitroAction>> headerActions, std::optional<std::function<void(std::optional<bool> /* animated */)>> onWillAppear, std::optional<std::function<void(std::optional<bool> /* animated */)>> onWillDisappear, std::optional<std::function<void(std::optional<bool> /* animated */)>> onDidAppear, std::optional<std::function<void(std::optional<bool> /* animated */)>> onDidDisappear, std::optional<std::function<void()>> onPopped): mapButtons(mapButtons), headerActions(headerActions), onWillAppear(onWillAppear), onWillDisappear(onWillDisappear), onDidAppear(onDidAppear), onDidDisappear(onDidDisappear), onPopped(onPopped) {}
  };
...
namespace margelo::nitro {
  ...
  // C++ MapWithContentTemplateConfig <> JS MapWithContentTemplateConfig (object)
  template <>
  struct JSIConverter<margelo::nitro::at::g4rb4g3::autoplay::hybrid::MapWithContentTemplateConfig> final {
    static inline margelo::nitro::at::g4rb4g3::autoplay::hybrid::MapWithContentTemplateConfig fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::at::g4rb4g3::autoplay::hybrid::MapWithContentTemplateConfig(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::at::g4rb4g3::autoplay::hybrid::MapWithContentTemplateConfig& arg) {
