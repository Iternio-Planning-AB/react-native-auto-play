...
namespace margelo::nitro::at::g4rb4g3::autoplay::hybrid {
  ...
  /**
   * A struct which can be represented as a JavaScript object (PreferredLane).
   */
  ...
  public:
    PreferredLane() = default;
    explicit PreferredLane(double highlightedAngle, bool isPreferred, std::vector<double> angles): highlightedAngle(highlightedAngle), isPreferred(isPreferred), angles(angles) {}
  };
...
namespace margelo::nitro {
  ...
  // C++ PreferredLane <> JS PreferredLane (object)
  template <>
  struct JSIConverter<margelo::nitro::at::g4rb4g3::autoplay::hybrid::PreferredLane> final {
    static inline margelo::nitro::at::g4rb4g3::autoplay::hybrid::PreferredLane fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::at::g4rb4g3::autoplay::hybrid::PreferredLane(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::at::g4rb4g3::autoplay::hybrid::PreferredLane& arg) {
