...
open class HybridAutoPlaySpec_cxx {
  ...
  @inline(__always)
  public final func navigate(latitude: Double, longitude: Double, label: std.string) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.navigate(latitude: latitude, longitude: longitude, label: String(label))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_void__ in
        let __promise = bridge.create_std__shared_ptr_Promise_void__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_void__(__promise)
        __result
