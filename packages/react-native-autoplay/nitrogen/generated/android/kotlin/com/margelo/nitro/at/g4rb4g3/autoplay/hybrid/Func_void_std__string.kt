...
/**
 * Represents the JavaScript callback `(clusterId: string) => void`.
...
fun interface Func_void_std__string: (String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(clusterId: String): Unit
}
...
class Func_void_std__string_cxx: Func_void_std__string {
  ...
  @Keep
  override fun invoke(clusterId: String): Unit
    = invoke_cxx(clusterId)

  @FastNative
  private external fun invoke_cxx(clusterId: String): Unit
}
...
class Func_void_std__string_java(private val function: (String) -> Unit): Func_void_std__string {
  ...
  @Keep
  override fun invoke(clusterId: String): Unit {
    return this.function(clusterId)
  }
}
