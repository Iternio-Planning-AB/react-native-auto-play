...
data class NitroMapTemplateConfig
  ...
  constructor(
    ...
    @DoNotStrip
    @Keep
    val onSafeAreaInsetsDidChange: Func_void_double_double_double_double_std__optional_bool_?,
    @DoNotStrip
    @Keep
    val id: String,
    @DoNotStrip
