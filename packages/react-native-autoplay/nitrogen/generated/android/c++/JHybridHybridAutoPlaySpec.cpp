...
namespace margelo::nitro::at::g4rb4g3::autoplay::hybrid {
  ...
  std::shared_ptr<Promise<void>> JHybridHybridAutoPlaySpec::setTemplateHeaderActions(const std::string& templateId, const std::optional<std::vector<NitroAction>>& headerActions) {
