///
/// JMapWithContentTemplateConfig.hpp
...
namespace margelo::nitro::at::g4rb4g3::autoplay::hybrid {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "MapWithContentTemplateConfig" and the the Kotlin data class "MapWithContentTemplateConfig".
   */
  struct JMapWithContentTemplateConfig final: public jni::JavaClass<JMapWithContentTemplateConfig> {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/at/g4rb4g3/autoplay/hybrid/MapWithContentTemplateConfig;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct MapWithContentTemplateConfig by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    MapWithContentTemplateConfig toCpp() const {
      ...
      return MapWithContentTemplateConfig(
