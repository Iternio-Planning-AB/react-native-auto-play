///
/// JPointOfInterestTemplateConfig.hpp
...
namespace margelo::nitro::swe::iternio::reactnativeautoplay {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "PointOfInterestTemplateConfig" and the the Kotlin data class "PointOfInterestTemplateConfig".
   */
  struct JPointOfInterestTemplateConfig final: public jni::JavaClass<JPointOfInterestTemplateConfig> {
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/swe/iternio/reactnativeautoplay/PointOfInterestTemplateConfig;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct PointOfInterestTemplateConfig by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    PointOfInterestTemplateConfig toCpp() const {
      ...
      static const auto fieldItems = clazz->getField<jni::JArrayClass<JPointOfInterest>>("items");
      jni::local_ref<jni::JArrayClass<JPointOfInterest>> items = this->getFieldValue(fieldItems);
      static const auto fieldActionStrip = clazz->getField<JNitroActionStrip>("actionStrip");
      jni::local_ref<JNitroActionStrip> actionStrip = this->getFieldValue(fieldActionStrip);
      static const auto fieldColors = clazz->getField<JNitroPointOfInterestColors>("colors");
      jni::local_ref<JNitroPointOfInterestColors> colors = this->getFieldValue(fieldColors);
      static const auto fieldOnSelectItem = clazz->getField<JFunc_void_std__string::javaobject>("onSelectItem");
      jni::local_ref<JFunc_void_std__string::javaobject> onSelectItem = this->getFieldValue(fieldOnSelectItem);
      return PointOfInterestTemplateConfig(
        id->toStdString(),
        ...
        [&](auto&& __input) {
          ...
          std::vector<PointOfInterest> __vector;
        ...
        actionStrip != nullptr ? std::make_optional(actionStrip->toCpp()) : std::nullopt,
        colors != nullptr ? std::make_optional(colors->toCpp()) : std::nullopt,
        onSelectItem != nullptr ? std::make_optional([&]() -> std::function<void(const std::string& /* itemId */)> {
          if (onSelectItem->isInstanceOf(JFunc_void_std__string_cxx::javaClassStatic())) [[likely]] {
            auto downcast = jni::static_ref_cast<JFunc_void_std__string_cxx::javaobject>(onSelectItem);
            return downcast->cthis()->getFunction();
          } else {
            auto onSelectItemRef = jni::make_global(onSelectItem);
            return JNICallable<JFunc_void_std__string, void(std::string)>(std::move(onSelectItemRef));
          }
        }()) : std::nullopt
      );
    }
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JPointOfInterestTemplateConfig::javaobject> fromCpp(const PointOfInterestTemplateConfig& value) {
      using JSignature = JPointOfInterestTemplateConfig(jni::alias_ref<jni::JString>, jni::alias_ref<JFunc_void_std__optional_bool_::javaobject>, jni::alias_ref<JFunc_void_std__optional_bool_::javaobject>, jni::alias_ref<JFunc_void_std__optional_bool_::javaobject>, jni::alias_ref<JFunc_void_std__optional_bool_::javaobject>, jni::alias_ref<JFunc_void::javaobject>, jni::alias_ref<jni::JDouble>, jni::alias_ref<JAutoText>, jni::alias_ref<jni::JArrayClass<JPointOfInterest>>, jni::alias_ref<JNitroActionStrip>, jni::alias_ref<JNitroPointOfInterestColors>, jni::alias_ref<JFunc_void_std__string::javaobject>);
      static const auto clazz = javaClassStatic();
      ...
      return create(
        ...
        value.actionStrip.has_value() ? JNitroActionStrip::fromCpp(value.actionStrip.value()) : nullptr,
        value.colors.has_value() ? JNitroPointOfInterestColors::fromCpp(value.colors.value()) : nullptr,
        value.onSelectItem.has_value() ? JFunc_void_std__string_cxx::fromCpp(value.onSelectItem.value()) : nullptr
      );
    }
  };
