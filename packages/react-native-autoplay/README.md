...
- [`android/`](android): All your `android`-specific implementations.
  ...
  - [`src/main/java/com/margelo/nitro/autoplay/`](android/src/main/java/com/margelo/nitro/autoplay/): All Kotlin implementations.
    - [`NitroAutoplayPackage.kt`](android/src/main/java/com/margelo/nitro/autoplay/NitroAutoplayPackage.kt): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.kt` file. In here, you can autolink all Kotlin HybridObjects.
